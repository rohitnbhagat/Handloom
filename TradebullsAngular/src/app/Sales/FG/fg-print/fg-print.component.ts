...
import { FG_Item_ViewModel } from '../../../Models/Sales/FGModel';

@Component({
  selector: 'app-fg-print',
  templateUrl: './fg-print.component.html',
  styleUrl: './fg-print.component.css'
})
export class FgPrintComponent implements OnInit, AfterContentInit {
  ...
  @Output() BackEvent = new EventEmitter<void>();
    ...
    Remarks: string = "";
    TotalQty: number = 0;
    ProductDetails: FG_Item_ViewModel[] = [];
        ...
        (response: any) => {
          ...
          if (!response.success) {
            ...
            if (order) {
              ...
              this.VoucherNo = order.FGNo;
              this.VoucherDate = order.FGDate;
  ...
  GetProductDetails(ProductID:number): FG_Item_ViewModel[]{
