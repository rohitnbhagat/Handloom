...
{
    public class SalesOrder_ViewModel
    {
    ...
    public class SalesOrder_AddModel
    {
        public long SalesOrderID { get; set; }
        public string SalesOrderNo { get; set; }
        public DateTime SalesOrderDate { get; set; }
        ...
        public string Remarks { get; set; }
        public List<SalesOrder_Item_AddModel> Items { get; set; }
        ...
        public List<SalesOrder_Tax_AddModel> Taxes { get; set; }

    }
    public class SalesOrder_Item_AddModel
    {
        public long ID { get; set; }
        public long SrNo { get; set; }
        public long ParentProductID { get; set; }
        public long ProductID { get; set; }
        public List<SalesOrder_Item_Attribute_AddModel> AttributeValues { get; set; }
        public List<SalesOrder_Item_Tax_AddModel> Taxes { get; set; }
    ...
    public class SalesOrder_Tax_AddModel
    {
    ...
    public class SalesOrder_Item_Attribute_AddModel
    {
        public long ProductAttributeID { get; set; }
        public long ProductAttributeValueID { get; set; }
    }
    public class SalesOrder_Item_Tax_AddModel
    {
        public long TaxRateID { get; set; }
        public long TaxClassID { get; set; }
        public string name { get; set; }
    ...
    public class SalesOrder_Item_ViewModel
    {
        public long ID { get; set; }
        public long SalesOrderID { get; set; }
        public long SrNo { get; set; }
        ...
        public List<SalesOrder_Item_Attribute_ViewModel> AttributeValues { get; set; }
        public List<SalesOrder_Item_Tax_ViewModel> Taxes { get; set; }
    }
    public class SalesOrder_Parent_Item_ViewModel
    {
        public long SalesOrderID { get; set; }
        public long SrNo { get; set; }
        public long ProductID { get; set; }
    ...
    public class SalesOrder_Item_Attribute_ViewModel
    {
        public long SalesOrderID { get; set; }
    ...
    public class SalesOrder_Item_Tax_ViewModel
    {
        public long SalesOrderID { get; set; }
        public long SalesOrderItemID { get; set; }
    ...
    public class SalesOrder_Tax_ViewModel
    {
        public long SalesOrderID { get; set; }
        public long SalesOrderTaxID { get; set; }
        public long TaxRateID { get; set; }
        public long TaxClassID { get; set; }
        public string TaxName { get; set; }
        public decimal Rate { get; set; }
    ...
    public class SalesOrder_Report_Filter
    {
        public string SalesOrderNo { get; set; }
        ...
        public string SalesLocationIDs { get; set; }
        public string ExhibitionIDs { get; set; }
    }

    public class SalesOrder_Filter
    {
        public long SalesOrderID { get; set; }
        public DateTime? FromDate { get; set; }
        public DateTime? ToDate { get; set; }
