...
{
    public class FG_AddModel
    {
        public long FGID { get; set; }
        public string FGNo { get; set; }
        public DateTime FGDate { get; set; }
        public string Remarks { get; set; }
        public decimal TotalQty { get; set; }
        public List<FG_Item_AddModel> Items { get; set; }

    }
    public class FG_Item_AddModel
    {
    ...
    public class FG_ProcessIn_ViewModel
    {
    ...
    public class FG_ProcessIn_Item_ViewModel
    {
        public long WOPlanningItemComponentID { get; set; }
    ...
    public class FG_ViewModel
    {
        ...
        public List<FG_Item_ViewModel> Items { get; set; }

    }
    public class FG_Item_ViewModel
    {
        public long ID { get; set; }
        public long FGID { get; set; }
        public long WOPlanningItemComponentID { get; set; }
